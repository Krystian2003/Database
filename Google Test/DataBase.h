...
public:
    ...
    // Funkcja sprawdza, czy podany plik istnieje. Jeśli nie, tworzy go (Nie jest niezbędna do działania programu)
    // Parametr: plik_nazwa - nazwa pliku, który chcemy znale��
    void czy_plik_istnieje(const string& plik_nazwa);
